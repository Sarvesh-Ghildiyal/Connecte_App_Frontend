...
export default function Dashboard() {
  ...
  return (
    <div>
      ...
      <div
        className={`mb-10 p-6 mt-4 ${isMetaConnected ? 'bg-[#FFFFFF]' : 'bg-[#FFFFFF] border-l-4 border-amber-400'
          }`}
      >
        {isMetaConnected ? (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
              ...
              <div className="flex border border-[#E8E8E8] p-0.5 bg-[#F9F9F9] self-start sm:self-auto shrink-0">
                <button
                  ...
                  className={`px-4 py-1.5 text-[9px] font-black tracking-widest uppercase transition-all ${statsMode === 'last'
                ...
                <button
                  ...
                  className={`px-4 py-1.5 text-[9px] font-black tracking-widest uppercase transition-all ${statsMode === 'all'
                      ? 'bg-[#1B1B1B] text-white'
                      : 'text-[#1B1B1B]/40 hover:text-[#1B1B1B]'
                    }`}
                >
